...
├── get-shit-done-teams/     # Skill resources
...
**get-shit-done-teams/references/**
...
**New Slash Command:**
- Primary code: `commands/gsd-teams/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `get-shit-done-teams/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-shit-done-teams/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-shit-done-teams/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-shit-done-teams/references/{name}.md`
