...
> **Note:** Planning methodology is in `agents/gsd-teams-planner.md`.
...
<!-- For checkpoint task examples and patterns, see @~/.claude/get-shit-done-teams/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/gsd-teams:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `~/.claude/get-shit-done-teams/references/tdd.md` for TDD plan structure.
...
See `~/.claude/get-shit-done-teams/templates/user-setup.md` for full schema and examples
...
See `~/.claude/get-shit-done-teams/workflows/verify-phase.md` for verification logic.
