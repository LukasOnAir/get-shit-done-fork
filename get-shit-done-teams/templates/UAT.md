...
- This section feeds directly into /gsd-teams:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gsd-teams:plan-phase --gaps with root causes
...
**Creation:** When /gsd-teams:verify-work starts new session
