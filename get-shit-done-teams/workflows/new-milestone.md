...
- Check for MILESTONE-CONTEXT.md (from /gsd-teams:discuss-milestone)
...
```bash
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js init new-milestone)
```
...
**Persist choice to config** (so future `/gsd-teams:plan-phase` honors it):

```bash
# If "Research first": persist true
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js config-set workflow.research true

# If "Skip research": persist false
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js config-set workflow.research false
```
...
Spawn 4 parallel gsd-teams-project-researcher agents. Each uses this template with dimension-specific fields:
...
Use template: ~/.claude/get-shit-done-teams/templates/research-project/{FILE}
</output>
", subagent_type="gsd-teams-project-researcher", model="{researcher_model}", description="{DIMENSION} research")
```
...
**Commit requirements:**
```bash
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
...
`/gsd-teams:discuss-phase [N]` — gather context and clarify approach

<sub>`/clear` first → fresh context window</sub>

Also: `/gsd-teams:plan-phase [N]` — skip discussion, plan directly
```
...
- [ ] gsd-teams-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md phases continue from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step: `/gsd-teams:discuss-phase [N]`
