...
<required_reading>
@~/.claude/get-shit-done-teams/references/verification-patterns.md
@~/.claude/get-shit-done-teams/templates/verification-report.md
</required_reading>
...
Use gsd-teams-tools to extract must_haves from each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js frontmatter get "$plan" --field must_haves)
...
Use gsd-teams-tools for artifact verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js verify artifacts "$plan")
...
Use gsd-teams-tools for key link verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js verify key-links "$plan")
...
See ~/.claude/get-shit-done-teams/templates/verification-report.md for complete template.
</step>
