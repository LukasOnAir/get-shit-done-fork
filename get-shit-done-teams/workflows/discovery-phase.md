...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gsd-teams:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/get-shit-done-teams/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/get-shit-done-teams/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/get-shit-done-teams/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/get-shit-done-teams/templates/discovery.md
...
Use ~/.claude/get-shit-done-teams/templates/discovery.md.
...
1. Discuss phase context (/gsd-teams:discuss-phase [current-phase])
2. Create phase plan (/gsd-teams:plan-phase [current-phase])
