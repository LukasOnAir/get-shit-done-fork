...
```bash
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js config-ensure-section
...
```
These settings apply to future /gsd-teams:plan-phase and /gsd-teams:execute-phase runs.

Quick commands:
- /gsd-teams:set-profile <profile> — switch model profile
- /gsd-teams:plan-phase --research — force research
- /gsd-teams:plan-phase --skip-research — skip research
- /gsd-teams:plan-phase --skip-verify — skip plan check
```
</step>
