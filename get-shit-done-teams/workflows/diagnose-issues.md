...
```bash
node ~/.claude/get-shit-done-teams/bin/gsd-teams-tools.js commit "docs({phase}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase}-UAT.md"
```
</step>
...
- Can resume with /gsd-teams:debug
